...
This installs `distill` to `/usr/local/bin`. If a previous version is already installed, the installer will prompt you to upgrade.
...
This removes `distill` from `/usr/local/bin`.
